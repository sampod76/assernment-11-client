        ...
        <div className="navbar rounded-t-xl my-1 shadow-2xl bg-gradient-to-r from-cyan-500 to-blue-500 text-white">
            ...
            <div className="navbar-center hidden md:flex">
                <ul className="menu menu-horizontal p-0">
                    <Link className='mr-2 bg-slate-600 p-2 rounded-lg hover:bg-violet-500 text-white font-bold hover:text-orange-600' to='/'><span>Home</span></Link>
                    <Link to='/reviews' className='mr-2 bg-slate-600 p-2 rounded-lg hover:bg-violet-500 text-white font-bold hover:text-orange-600'>Reviews</Link>
                    <Link className='mr-2 bg-slate-600 p-2 rounded-lg hover:bg-violet-500 text-white font-bold hover:text-orange-600' to='/delivery'><span>Services</span></Link>
                    <Link  className='mr-2 bg-slate-600 p-2 rounded-lg hover:bg-violet-500 text-white font-bold hover:text-orange-600' to='/addservices'><span>ADD Services</span></Link>

                    <Link className='mr-2 bg-slate-600 p-2 rounded-lg hover:bg-violet-500 text-white font-bold hover:text-orange-600' to='/blog'><span>Blog</span></Link>
                    {
                        user?.uid ? <>
                            <Link onClick={handleLogOut} className='mr-2 bg-slate-600 p-2 rounded-lg hover:bg-violet-500 text-white font-bold hover:text-orange-600'><span>Log Out</span></Link>
                        </> :
                            <>
                                <Link className='mr-2 bg-slate-600 p-2 rounded-lg hover:bg-violet-500 text-white font-bold hover:text-orange-600' to='/login'><span>Login</span></Link>
                                <Link className='mr-2 bg-slate-600 p-2 rounded-lg hover:bg-violet-500 text-white font-bold hover:text-orange-600' to='/register'><span>register</span></Link>
                            </>
                    }
