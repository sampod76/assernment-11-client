...
const Profile = () => {
    ...
    return (
        <div className="flex bg-blue-400 flex-col justify-center max-w-4xl p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100  mx-auto">
            {
            ...
            <div className="space-y-4 text-center divide-y divide-gray-700">
                <div className="my-2 space-y-1">
                    <h2 className="text-xs md:text-xl font-semibold sm:text-2xl">{user?.email}</h2>
                    <p className="px-5 text-xs sm:text-base dark:text-gray-400">{user.displayName}</p>
                </div>
